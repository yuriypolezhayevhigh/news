...
if ( ! function_exists( 'newses_sanitize_positive_integer' ) ) :
     ...
     */
    function newses_sanitize_positive_integer( $input, $setting ) {
...
if ( ! function_exists( 'newses_sanitize_number_range' ) ) :
     ...
     */
    function newses_sanitize_number_range( $input, $setting ) {
...
if ( ! function_exists( 'newses_sanitize_dropdown_pages' ) ) :
     ...
     */
    function newses_sanitize_dropdown_pages( $page_id, $setting ) {
...
if ( ! function_exists( 'newses_sanitize_image' ) ) :
     ...
     */
    function newses_sanitize_image( $image, $setting ) {
