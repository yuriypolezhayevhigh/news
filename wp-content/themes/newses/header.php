...
<?php _e( 'Skip to content', 'newses' ); ?></a>
    ...
    <div class="wrapper">
        <header class="mg-headwidget">
            ...
            <div class="mg-nav-widget-area-back" style='background: url("<?php echo esc_url( $background_image ); ?>" );'>
            ...
            $newses_header_overlay_color = get_theme_mod('newses_header_overlay_color');?> style="background-color:<?php echo esc_attr($newses_header_overlay_color);?>;" <?php } ?>> 
                <div class="container">
